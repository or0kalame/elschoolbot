...
def get_marks_table(log='', passw='', html=''):
    if log != '' and passw != '' and html == '':
        ...
        try:
            with requests.Session() as s:
                ...
                table = s.get(
                    f'https://elschool.ru/users/diaries/grades?rooId={user_info[0]}&instituteId={user_info[1]}&departmentId={user_info[2]}&pupilId={user_id}')
...
def get_data(data_old, data_now):
